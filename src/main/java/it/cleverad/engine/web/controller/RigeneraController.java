...
public class RigeneraController {
    ...
    public void manageCPC(@ModelAttribute RigeneraCPCBusiness.FilterUpdate request) {
        rigeneraCPCBusiness.rigenera(Integer.parseInt(request.getYear()), Integer.parseInt(request.getMonth()), Integer.parseInt(request.getDay()), request.getAffiliateId());
    }
