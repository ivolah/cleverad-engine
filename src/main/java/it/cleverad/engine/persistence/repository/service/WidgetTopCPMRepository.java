...
public interface WidgetTopCPMRepository extends JpaRepository<WidgetTopCPM, Long>, JpaSpecificationExecutor<WidgetTopCPM> {
    ...
    @Query(nativeQuery = true, value = "Select distinct vall.affiliateId                                                                as affiliateId, " +
            ...
            " ORDER BY impressionNumber DESC;")
    List<TopAffiliates> searchTopAffilaites(@Param("dateFrom") LocalDateTime dateFrom, @Param("dateTo") LocalDateTime dateTo, @Param("dictionaryList") List<Long> dictionaryList, @Param("affiliateId") Long affiliateId, @Param("campaignid") Long campaignid );
